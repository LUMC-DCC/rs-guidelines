...
* An SMP encourages you to think about how your software will be documented, cited, and made available in appropriate repositories and registries with metadata, making it easier for others to find.
→ **Findability:** *It motivates assigning unique identifiers (like DOIs) and creating rich metadata.*

* By considering how your software and metadata will be stored and accessed, an SMP helps you plan for long-term availability, even as technologies or team members change.
→ **Accessibility:** *Planning for software storage and retrieval ensures long-term accessibility for users.*

* An SMP encourages you to adopt standards and formats that allow your software to work well with other research tools, datasets, or systems.
→ **Interoperability:** *This improves the software’s ability to communicate and integrate with other tools, supporting interoperability.*
