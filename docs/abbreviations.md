...
| AVG | Algemene Verordening Gegevensbescherming (the Dutch name for the GDPR) |
...
| NWO | Nederlandse Organisatie voor Wetenschappelijk Onderzoek (the Dutch Research Council) |
